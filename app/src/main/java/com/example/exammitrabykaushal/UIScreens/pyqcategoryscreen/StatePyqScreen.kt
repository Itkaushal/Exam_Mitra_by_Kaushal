    ...
    Scaffold(
        ...
        Column(
            ...
            LazyColumn(
                ...
                items(papers) { statepaper ->
                    StateExamPaperItemCard(statepaper, onClick = {
                        loadPdfFromFirebaseState(statepaper.key) { pdfUrl ->
                            if (pdfUrl != null) {
...
@RequiresApi(Build.VERSION_CODES.O)
fun loadPdfFromFirebaseState(paperKey: String, callback: (String?) -> Unit) {

    FirebaseDatabase.getInstance()
        .getReference("UPSSSC_PYQ")
        .child(paperKey)
        .get()
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ViewPdfScreenState(pdfUrl: String, onBack: () -> Unit) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("State Exam Previous Paper") },
                navigationIcon = {
                    IconButton(onClick = onBack) {
...
@Composable
fun StateExamPaperItemCard(paper: StateExamTestPaper, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
...
fun getDummyStateExamPapers(category: String): List<StateExamTestPaper> {
    return listOf(
        StateExamTestPaper("upsssc_pyq_1", "Upsssc Pet Shift 1", "28-Oct 2023", 100, "120 Min"),
        StateExamTestPaper("upsssc_pyq_1", "Upsssc Pet Shift 2", "28-Oct 2023", 100, "120 Min"),
        StateExamTestPaper("upsssc_pyq_1", "Upsssc Pet Shift 1", "29-Oct 2023", 100, "120 Min"),
