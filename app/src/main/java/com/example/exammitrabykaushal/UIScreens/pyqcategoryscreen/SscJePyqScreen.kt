...
fun JePyqScreen(
    ...
    val papers = getDummyJePapers(examName)
    ...
    Scaffold(
        ...
        Column(
            ...
            LazyColumn(
                ...
                items(papers) { jepaper ->
                    JePaperItemCard(jepaper, onClick = {
                        loadPdfFromFirebaseJe(jepaper.key) { pdfUrl ->
                            if (pdfUrl != null) {
...
@Composable
fun JePaperItemCard(paper: JeTestPaper, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
...
@RequiresApi(Build.VERSION_CODES.O)
fun loadPdfFromFirebaseJe(paperKey: String, callback: (String?) -> Unit) {

    FirebaseDatabase.getInstance()
        .getReference("RRB_JE_PYQ")
        .child(paperKey)
        .get()
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ViewPdfScreenJe(pdfUrl: String, onBack: () -> Unit) {
...
fun getDummyJePapers(category: String): List<JeTestPaper> {
    return listOf(
        JeTestPaper("je_pyq_1", "RRB JE Shift 1", "18-Dec 2024", 100, "120 Min"),
        JeTestPaper("je_pyq_2", "RRB JE Shift 2", "18-Dec 2024", 100, "120 Min"),
        JeTestPaper("je_pyq_3", "RRB JE Shift 3", "18-Dec 2024", 100, "120 Min"),
        JeTestPaper("je_pyq_4", "RRB JE Shift 1", "17-Dec 2024", 100, "120 Min"),
        JeTestPaper("je_pyq_5", "RRB JE Shift 2", "17-Dec 2024", 100, "120 Min"),
        JeTestPaper("je_pyq_6", "RRB JE Shift 3", "17-Dec 2024", 100, "120 Min"),
        JeTestPaper("je_pyq_7", "RRB JE Shift 3", "16-Dec 2024", 100, "120 Min"),
        JeTestPaper("je_pyq_8", "RRB JE Shift 2", "16-Dec 2024", 100, "120 Min"),
        JeTestPaper("je_pyq_9", "RRB JE Shift 1", "16-Dec 2024", 100, "120 Min"),
        JeTestPaper("je_pyq_10", "RRB JE(electronic allied enginee.) Shift 1", "18-12-2024", 100, "120 Min"),
        )
}