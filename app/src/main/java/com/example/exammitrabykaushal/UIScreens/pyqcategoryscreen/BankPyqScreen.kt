...
fun BankPyqScreen(
    ...
    val papers = getDummyBankPapers(examName)
    ...
    Scaffold(
        ...
        // Light Grey Background
            ...
            LazyColumn(
                ...
                items(papers) { bankpaper ->
                    BankPaperItemCard(bankpaper, onClick = {
                        loadPdfFromFirebaseBank(bankpaper.key) { pdfUrl ->
                            if (pdfUrl != null) {
...
@RequiresApi(Build.VERSION_CODES.O)
fun loadPdfFromFirebaseBank(paperKey: String, callback: (String?) -> Unit) {

    FirebaseDatabase.getInstance()
        .getReference("BANK_PYQ")
        .child(paperKey)
        .get()
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ViewPdfScreenBank(pdfUrl: String, onBack: () -> Unit) {
...
@Composable
fun BankPaperItemCard(paper: BankTestPaper, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
...
fun getDummyBankPapers(category: String): List<BankTestPaper> {
    return listOf(
        BankTestPaper("bank_pyq_1", "Bank IBPS Shift 1", "12-Dec 2024", 100, "120 Min"),
        BankTestPaper("bank_pyq_2", "Bank IBPS Shift 1", "15-Dec 2024", 100, "120 Min"),
        BankTestPaper("bank_pyq_3", "Bank IBPS Shift 1", "06-Dec 2024", 100, "120 Min"),
        BankTestPaper("bank_pyq_4", "Bank IBPS Shift 1", "14-Dec 2024", 100, "120 Min"),
        BankTestPaper("bank_pyq_5", "Bank IBPS Shift 1", "02-Dec 2024", 100, "120 Min"),
    )
}